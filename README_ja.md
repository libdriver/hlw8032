...
HLW8032は、CMOSプロセスを用いて製造され、主に単相アプリケーションに適用される高精度電力計測ICです。線間電圧と電流を測定し、有効電力、皮相電力、力率を算出できます。

LibDriver HLW8032は、LibDriverがリリースしたHLW8032用のフル機能ドライバです。有効電圧、有効電流、有効電力、皮相電力、力率、電力量の計測に加え、追加機能も提供します。LibDriverはMISRAに準拠しています。
...
/ srcディレクトリには、LibDriver HLW8032のソースファイルが含まれています。

/ interfaceディレクトリには、LibDriver HLW8032用のプラットフォームに依存しないUARTバステンプレートが含まれています。

/ testディレクトリには、チップの必要な機能を簡単にテストできるLibDriver HLW8032ドライバーテストプログラムが含まれています。

/ exampleディレクトリには、LibDriver HLW8032プログラミング例が含まれています。

/ docディレクトリには、LibDriver HLW8032オフラインドキュメントが含まれています。

/ datasheetディレクトリには、HLW8032データシートが含まれています。
...
オンラインドキュメント: [https://www.libdriver.com/docs/hlw8032/index.html](https://www.libdriver.com/docs/hlw8032/index.html)。
