...
HLW8032는 CMOS 공정으로 제조된 고정밀 전기 에너지 계측 IC로, 주로 단상 전력 시스템에 적용됩니다. 선간 전압과 전류를 측정하고 유효 전력, 피상 전력, 역률을 계산할 수 있습니다.

LibDriver HLW8032는 LibDriver에서 출시한 HLW8032용 모든 기능을 갖춘 드라이버입니다. 유효 전압, 유효 전류, 유효 전력, 피상 전력, 역률, 전력량 및 추가 기능을 제공합니다. LibDriver는 MISRA 표준을 준수합니다.
...
/src 디렉토리에는 LibDriver HLW8032의 소스 파일이 포함되어 있습니다.

/interface 디렉토리에는 LibDriver HLW8032용 플랫폼 독립적인 UART버스 템플릿이 포함되어 있습니다.

/test 디렉토리에는 LibDriver HLW8032드라이버 테스트 프로그램이 포함되어 있어 칩의 필요한 기능을 간단히 테스트할 수 있습니다.

/example 디렉토리에는 LibDriver HLW8032프로그래밍 예제가 포함되어 있습니다.

/doc 디렉토리에는 LibDriver HLW8032오프라인 문서가 포함되어 있습니다.

/datasheet 디렉토리에는 HLW8032데이터시트가 있습니다.
...
온라인 문서: [https://www.libdriver.com/docs/hlw8032/index.html](https://www.libdriver.com/docs/hlw8032/index.html).
