...
HLW8032是一款高精度的电能计量IC,它采用CMOS制造工艺，主要用于单相应用。它能够测量线电压和电流，并能计算有功功率，视在功率和功率因素。

LibDriver HLW8032是LibDriver推出的HLW8032全功能驱动，该驱动提供有效电压读取，有效电流读取，有功功率读取，视在功率读取，功率因数读取，电量读取等功能并且它符合MISRA标准。
...
/src目录包含了LibDriver HLW8032的源文件。

/interface目录包含了LibDriver HLW8032与平台无关的UART总线模板。

/test目录包含了LibDriver HLW8032驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver HLW8032编程范例。

/doc目录包含了LibDriver HLW8032离线文档。

/datasheet目录包含了HLW8032数据手册。
...
在线文档: [https://www.libdriver.com/docs/hlw8032/index.html](https://www.libdriver.com/docs/hlw8032/index.html)。
